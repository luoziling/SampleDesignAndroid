...
public class ModelDetailFragment extends Fragment implements View.OnClickListener {

	private ModelDetailViewModel homeViewModel;
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		homeViewModel =
				ViewModelProviders.of(this).get(ModelDetailViewModel.class);
		View root = inflater.inflate(R.layout.fragment_model_detail, container, false);
