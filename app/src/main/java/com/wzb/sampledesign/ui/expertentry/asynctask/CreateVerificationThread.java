 ...
 * Description:
 */
public class CreateVerificationThread implements Runnable {

	private Handler handler;
	private String projectName;

	public CreateVerificationThread() {
	}

	public CreateVerificationThread(Handler handler, String projectName) {
	...
	@Override
	public void run() {
		String url = Constant.urlHead1 + "/project_information/createVerification";

		Message message = new Message();
		Bundle msgBundle = new Bundle();

		message.what = Constant.CREATE_VERIFICATION;
		...
		OkHttpUtils
			...
			public void onResponse(String response) {
				...
				msgBundle.putBoolean("verification",res);
				message.setData(msgBundle);
				handler.sendMessage(message);
