...
public class FastjsonUtil {
	...
	public static String getString(String json, String key) {
		...
		try {
			...
			Log.e("fastjson", "fastjson get string error, json: {"+json+"}, key: {"+key+"}" + e);
//			log.error("fastjson get string error, json: {}, key: {}", json, key, e);
	...
	public static Integer getInt(String json, String key) {
		...
		try {
			...
			Log.e("fastjson", "fastjson get int error, json, json: {"+json+"}, key: {"+key+"}" + e);
//			log.error("fastjson get int error, json: {}, key: {}", json, key, e);
	...
	public static Long getLong(String json, String key) {
		...
		try {
			...
			Log.e("fastjson", "fastjson get long error, json: {"+json+"}, key: {"+key+"}" + e);
//			log.error("fastjson get long error, json: {}, key: {}", json, key, e);
	...
	public static Double getDouble(String json, String key) {
		...
		try {
			...
			Log.e("fastjson", "fastjson get double error, json: {"+json+"}, key: {"+key+"}" + e);
//			log.error("fastjson get double error, json: {}, key: {}", json, key, e);
	...
	public static BigInteger getBigInteger(String json, String key) {
		...
		try {
			...
			Log.e("fastjson", "fastjson get biginteger error, json: {}, key, json: {"+json+"}, key: {"+key+"}" + e);
//			log.error("fastjson get biginteger error, json: {}, key: {}", json, key, e);
	...
	public static BigDecimal getBigDecimal(String json, String key) {
		...
		try {
			...
			Log.e("fastjson", "fastjson get bigdecimal error, json: {"+json+"}, key: {"+key+"}" + e);
//			log.error("fastjson get bigdecimal error, json: {}, key: {}", json, key, e);
	...
	public static boolean getBoolean(String json, String key) {
		...
		try {
			...
			Log.e("fastjson", "fastjson get boolean error, json: {"+json+"}, key: {"+key+"}" + e);
	...
	public static <T> List<T> getList(String json, String key, Class<T> c) {
		...
		if (jsonObject != null) {
			try {
				...
				Log.e("fastjson", "fastjson get list error, json: {"+json+"}, key: {"+key+"}" + e);
//				log.error("fastjson get list error, json: {}, key: {}", json, key, e);
	...
	public static boolean isJson(String json) {
		try {
			...
			Log.e("fastjson", "fastjson check json error, json: {"+json+"}" + e);
